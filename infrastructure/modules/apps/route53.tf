...
# Requests a DNS-validated ACM certificate when HTTPS is enabled.
...
# Creates the Route 53 records required to validate the ACM certificate.
...
# Waits for ACM to validate the requested certificate.
...
# Creates the public DNS alias that points the application domain to the ALB.
